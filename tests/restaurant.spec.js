...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    const objetoRetornado = createMenu({ food: {}, drinks: {} });
    ...
    const variavelTeste = createMenu({ food: {}, drinks: {} });
    variavelTeste.order('coxinha');
    expect(variavelTeste.consumption).toEqual([ 'coxinha' ]);    
    // ```
    ...
    let chulambes = createMenu({ food: {}, drinks: {} });
    chulambes.order("coxinha");
    chulambes.order("agua");
    chulambes.order("sopa");
    chulambes.order("sashimi");
    expect(chulambes.consumption).toEqual([ 'coxinha', 'agua', 'sopa', 'sashimi' ]);
    // --------------------------------------------------------------------------------------
    ...
    let xamblau = createMenu({ food: {}, drinks: {} });
    xamblau.order('coxinha');
    xamblau.order('agua');
    xamblau.order('coxinha');
    expect(xamblau.consumption).toEqual(['coxinha', 'agua', 'coxinha']);
    ...
    // fail('Teste vazio!');
    let xman = createMenu( {food: { coxinha: 3.9, coxinha: 3.9}, drinks: { agua: 3.9},});
    xman.order('coxinha');
    xman.order('agua');
    xman.order('coxinha');
    expect(xman.pay()).toBeCloseTo(12.87);
  });
});
